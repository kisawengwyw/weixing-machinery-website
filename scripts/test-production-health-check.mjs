...
try {
  ...
  await test('full correct site fixture passes', async () => {
    ...
    const fixtureFetch = async (raw, init = {}) => {
      ...
      if (url.pathname === '/sitemap.xml') return new Response('<urlset><url><loc>https://www.weixingmachinery.com/</loc></url><url><loc>https://www.weixingmachinery.com/zh/</loc></url></urlset>', { status: 200, headers: { 'content-type': 'application/xml' } });
